...
/***/ function(module, exports, __webpack_require__) {
	...
	var _KanbanBoard = __webpack_require__(161);
	...
	var KanbanBoard = function (_Component) {
		...
		_createClass(KanbanBoard, [{
			...
			value: function componentDidMount() {
				...
				var _test2 = _slicedToArray(_test, 3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CheckList = __webpack_require__(164);
		...
		_createClass(Card, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: this.state.showDetails ? "c-card__title--is-open" : "c-card__title", onClick: this.toggleDetails.bind(this) },
						this.props.title
					),
					cardDetails
				);
		...
		_createClass(CheckList, [{
			...
			value: function render() {
				var tasks = this.props.tasks.map(function (task) {
					return _react2.default.createElement(
						'li',
						{ className: 'c-checklist__task' },
						_react2.default.createElement('input', { type: 'checkbox', defaultChecked: task.done }),
						task.name,
						_react2.default.createElement('a', { href: '', className: 'c-checklist__task--remove' })
					);
				});
